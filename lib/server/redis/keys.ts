/** Centralized cache key builders. Prefix `cache:` keeps ASR queue keys (`asr:*`) isolated. */
...
/** Pages/limits we may have written; used for explicit invalidation without SCAN. */
...
/** All known video-list keys for a product (explicit delete set). */
